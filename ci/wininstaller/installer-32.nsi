...
OutFile "OBS-Studio-${SHORTVERSION}-Installer-x86.exe"
...
Function PreReqCheck
	; Abort if 64 bit platform
	${if} ${RunningX64}
		MessageBox MB_OK|MB_ICONSTOP "This platform requires the 64-bit version of OBS Studio." 
		Quit
	${endif}
