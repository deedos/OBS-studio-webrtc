...
OutFile "OBS-Studio-${SHORTVERSION}-Installer-multi.exe"
...
Function .onInit
	${if} $InstDir == "" ; Don't override /D=c:\custom\dir
		${if} ${RunningX64}
...
Function PreReqCheck
	...
	${if} ${RunningX64}
		...
		; IfErrors vs2017Missing vs2017OK1
		; vs2017Missing:
		; 	MessageBox MB_YESNO|MB_ICONEXCLAMATION "Your system is missing runtime components that ${APPNAME} requires. Please make sure to install both vcredist_x64 and vcredist_x86. Would you like to download them?" IDYES vs2017true IDNO vs2017false
		; 	vs2017true:
		; 		ExecShell "open" "https://obsproject.com/visual-studio-2017-runtimes"
		; 	vs2017false:
		; 	Quit
		; vs2017OK1:
		; ClearErrors
	...
	${else}
		...
		GetDLLVersion "vcruntime140.dll" $R0 $R1
		GetDLLVersion "msvcp140.dll" $R0 $R1
		IfErrors vs2017Missing32 vs2017OK32
		vs2017Missing32:
			MessageBox MB_YESNO|MB_ICONEXCLAMATION "Your system is missing runtime components that ${APPNAME} requires. Would you like to download them?" IDYES vs2017true32 IDNO vs2017false32
			vs2017true32:
